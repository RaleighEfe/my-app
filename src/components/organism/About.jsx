      ...
      <Layout>
        <div>
          ...
          <p className="text-lg font-normal py-5">
            ...
            technology. I create clean and intuitive interfaces using HTML, CSS,
            JavaScript, and frameworks like as React. I work closely with
            ...
            developments. {"Let's"} go on an exciting web development adventure
            together!
          </p>
        </div>
        <div className="">
